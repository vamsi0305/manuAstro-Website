import { ArrowRight, ShieldCheck, Heart, Moon, Sparkles as Stars } from 'lucide-react'
    ...
    <div className="bg-[#fdf7ed]">
      ...
      <section className="section" style={{ position: 'relative', overflow: 'hidden', minHeight: '400px', display: 'flex', alignItems: 'center' }}>
        <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
          <img src="https://manuastro.com/cdn/shop/files/Personal_Consultation_New_500x500_jpg.jpg?v=1770036746" alt="Personal Consultation" className="w-full h-full object-cover opacity-15" />
